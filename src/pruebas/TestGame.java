...
public class TestGame {
	...
	/**
	 * Prueba 1: Verificar que el constructor sin parámetros inicializa
	 * correctamente
	 */
	@Test
	...
	public void testMoverJugadorArriba() {
		...
		assertEquals("El jugador debe moverse una fila arriba", filaInicial - 1, player.getRow());
	}
	...
	public void testMoverJugadorDerecha() {
		...
		assertEquals("El jugador debe moverse una columna a la derecha", columnaInicial, player.getColumn());
	}
	...
	public void testMovimientoBloqueadoPorHielo() {
		...
		assertEquals("El jugador no debe moverse", columna, player.getColumn() - 1);
	}
	...
	public void testCrearHieloConPlayerShoot() {
		...
		assertTrue("Debe haber hielo después de disparar", game.getMap().hasIce(x, y + 1));
	}
	...
	public void testDestruirHieloExistente() {
		...
		assertTrue("Debe haber hielo", game.getMap().hasIce(x, y+1));

		// Destruir hielo
		game.playerShootIce(0, 1, 0);
		assertFalse("No debe haber hielo después de destruir", game.getMap().hasIce(x, y-1));
	}
