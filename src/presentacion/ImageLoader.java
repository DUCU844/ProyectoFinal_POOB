...
/**
 * Utility class to load and cache game images. Handles all sprite loading and
 * provides scaled versions.
 * 
...
public class ImageLoader {
	...
	private static final String IMAGE_PATH = "/recursos/images/";
	...
	public static BufferedImage loadBackground() {
		return loadImage("background.png"); //
	}

	/**
	 * Creates a placeholder image when the real image is not found. This prevents
	 * crashes and shows what's missing.
	 * 
	...
	/**
	 * Pre-loads all game images at startup. Call this during game initialization to
	 * avoid lag during gameplay.
	 */
